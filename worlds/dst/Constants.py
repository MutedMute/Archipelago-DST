...
BOSS_PREREQUISITES = {
    ...
    "Crystal Deerclops":  {"Celestial Champion"},
    "Armoured Bearger":   {"Celestial Champion"},
    "Possessed Varg":     {"Celestial Champion"},
    "Celestial Revenant": {"Celestial Champion"},
    "Enlightened W.A.R.B.O.T": {"Celestial Champion"},
    "Celestial Scion":    {"Celestial Champion"},
}
...
DSTAP_LOCATIONS = [
    ...
    [278,   "Armoured Bearger",          "mutatedbearger",           [ "boss", "seasonal", "autumn", "seasons_passed_5" ] ],
